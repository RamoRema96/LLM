...
## Ollama Alternative ?
# It may work: in this LangChain page you will find the list of "LLM" integrations, including AWS with Bedrock and Ollama.
# It looks that ChatOllama is the Ollama chatbot model
# bedrock chatmodel -> https://python.langchain.com/api_reference/aws/chat_models.html
...
print(prompt)
part_1_assistant_runnable = create_react_agent(
    llm, part_1_tools, prompt
